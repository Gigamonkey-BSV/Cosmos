...
protected:
    ...
    ::restore_wallet_type RestoreWalletType {::restore_wallet_type::unset};
...
public:
    ...
    generate_request_options &restore_wallet_type (::restore_wallet_type);
    ...
    ::mnemonic_style mnemonic_style () const {
        return MnemonicStyle;
    }

    ::wallet_style wallet_style () const {
        if (WalletStyle == ::wallet_style::invalid && RestoreWalletType != ::restore_wallet_type::unset)
            return ::wallet_style::BIP_44;
        return WalletStyle;
    }
