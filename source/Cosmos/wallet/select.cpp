...
namespace Cosmos {
    ...
    namespace {
        ...
        struct drop_down {
            ...
            drop_down (
                ...
                double min_change_fraction,
                crypto::entropy &r): Result {}, SpentValue {acc.value ()}, InputsExpectedSize {0} {
    ...
    selected select_down::operator ()
        (const account &acc, Bitcoin::satoshi value_to_spend, satoshis_per_byte fees, crypto::entropy &r) const {
