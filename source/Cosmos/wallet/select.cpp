...
namespace Cosmos {
        ...
        struct drop_down {
            ...
            void reduce (
                ...
                while (true) {
                    ...
                    data::cross<double> weights (size (rmv));
                    ...
                    uint32 selected_removable_index = data::select_index_by_weight (weights, r);
            ...
            drop_down (
                ...
                double min_change_fraction,
                data::entropy &r): Result {}, SpentValue {acc.value ()}, InputsExpectedSize {0} {
    ...
    selected select_down::operator ()
        (const account &acc, Bitcoin::satoshi value_to_spend, satoshis_per_byte fees, data::entropy &r) const {
